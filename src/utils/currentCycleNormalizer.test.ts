...
describe('normalizeCurrentCycle', () => {
  it('maps enriched cycle metrics, delayed members and beneficiary net amount', () => {
  ...
  it('falls back to legacy fields when enriched metrics are absent', () => {
    const cycle = normalizeCurrentCycle({
      uid: 'cycle-legacy',
      cycleNumber: 2,
